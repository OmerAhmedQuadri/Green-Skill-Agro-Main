...
export function NotificationBell({ inverse = false }: { inverse?: boolean }) {
  ...
  return (
    <div className="relative">
      <button type="button" onClick={() => setOpen((o) => !o)} aria-expanded={open} aria-label={t('open', { count: unread })}
      ...
      {open ? (
        <div className="absolute end-0 z-50 mt-2 w-80 max-w-[calc(100vw-2rem)] rounded-lg border border-stone-200 bg-white text-stone-900 shadow-lg" role="dialog" aria-label={t('title')}>
