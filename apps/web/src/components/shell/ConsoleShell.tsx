...
import { Banknote, ListChecks, Target, CalendarCheck, CalendarClock, Car, ClipboardCheck, ClipboardList, History, LayoutDashboard, Menu, Package, PackageOpen, PackageX, Receipt, Settings, Ship, Store, Tag, Truck, Users, Warehouse, X } from 'lucide-react';
...
const ICONS = {
  ...
  vehicles: Car, attendance: CalendarCheck, closingStock: ClipboardCheck, stores: Store, sales: Receipt, dispatch: PackageOpen, cash: Banknote, audits: ListChecks, targets: Target, auditLog: History,
